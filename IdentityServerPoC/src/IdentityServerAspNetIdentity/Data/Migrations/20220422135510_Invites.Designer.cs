...
namespace IdentityServerAspNetIdentity.Data.Migrations
{
    ...
    [Migration("20220422135510_Invites")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityServerAspNetIdentity.Models.Invite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IdentityServerAspNetIdentity.Models.Invite", b =>
                {
                    b.HasOne("IdentityServerAspNetIdentity.Models.ApplicationUser", "From")
                        .WithMany()
                        .HasForeignKey("FromId");

                    b.HasOne("IdentityServerAspNetIdentity.Models.Directory", "ToDirectory")
                        .WithMany()
                        .HasForeignKey("ToDirectoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IdentityServerAspNetIdentity.Models.ApplicationUser", "To")
                        .WithMany("Invites")
                        .HasForeignKey("ToId");
